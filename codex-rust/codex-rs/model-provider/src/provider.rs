...
impl ModelProvider for ConfiguredModelProvider {
    ...
    fn models_manager(
        ...
        // When the user opts into local metadata, build a static catalog from
        // the `[[model_providers.<id>.models]]` entries and skip the remote fetch.
